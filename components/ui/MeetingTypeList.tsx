        ...
        <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
            ...
            {!callDetails? ( 
                ...
                >
                    ...
                    <div className='flex w-full flex-coll gap-2.5'>
            ...
            >
                <Input className='border-none bg-dark-3 focus-visible:right-0 focus-visible:ring-offset-0' placeholder='Meeting Link'
